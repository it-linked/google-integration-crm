        ...
        <div
            ...
            <div class="flex flex-col gap-4 px-4 py-2">
                @if ($account && in_array('calendar', $account->scopes ?? []))
                    <!-- Remove the account -->
                    <x-admin::form :action="route('admin.google.destroy', $account->id)" method="DELETE"
                        class="border-b border-gray-200 p-4 dark:border-gray-800">
                        <input name="route" type="hidden" value="calendar">

                        <div class="flex gap-2">
                            <img src="{{ vite()->asset('images/google-calendar-icon.png', 'google') }}"
                                class="h-10 w-10">
                    ...
                    <!-- Sync the account -->
                    <x-admin::form :action="route('admin.google.calendar.sync', $account->id)" method="POST">
                        <div class="w-1/2">
                            <x-admin::form.control-group>
                                ...
                                <x-admin::form.control-group.control type="text" name="account_name"
                            ...
                            <x-admin::form.control-group>
                                ...
                                <x-admin::form.control-group.control type="select" id="calendar_id" name="calendar_id"
                                    :value="$account?->calendars->first(fn($calendar) => $calendar?->is_primary)
                                        ?->id" :label="trans('google::app.calendar.index.title')" rules="required">
                ...
                @else
                    ...
                    <div class="flex">
                        <a href="{{ route('admin.google.store', ['route' => 'calendar']) }}" class="secondary-button">
